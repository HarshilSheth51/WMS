            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
				...
				<table class="table"> 
					...
					$q="select finish_good.product_name,place_master.location,party_master.party_name,outward_finishgood.* from outward_finishgood,finish_good,place_master,party_master where outward_finishgood.product_id=finish_good.product_id and outward_finishgood.place_id=place_master.place_id and outward_finishgood.party_id=party_master.party_id and outward_finishgood.user_id=$user_id";
