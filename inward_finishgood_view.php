            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Inward Finishgood View</h3>
				  <form method="get">
				  <input type="text" style="border: 2px line black; border-radius:9px; text-align:center; margin-left: 15% ; border-left-width:7px; font-family: serif; border-top-right-radius:10px; margin-top:10px;"name="search" placeholder="Enter date">
				...
				<table class="table"> 
					...
					$q="select place_master.location,finish_good.product_name,inward_finishgood.* from inward_finishgood,place_master,finish_good where inward_finishgood.place_id=place_master.place_id and inward_finishgood.product_id=finish_good.product_id  and inward_finishgood.user_id=$user_id";					
